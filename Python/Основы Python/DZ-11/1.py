...
for el in my_list:
    print(el)
    print(type(el))
    """нашла только такой вариант преообразования без онлайн-конвертера, 
    но тип не str, а bytes"""
    print(el.encode('unicode_escape'))
    print(type(el.encode('unicode_escape')))
