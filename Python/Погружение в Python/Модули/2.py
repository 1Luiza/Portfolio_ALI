...
def is_attacking(q1, q2):
    # Функция проверки, бьют ли ферзи друг друга
...
def check_queens(queens):
    # Функция проверки всех возможных пар ферзей
    for i in range(len(queens)):
        for j in range(i + 1, len(queens)):
            if is_attacking(queens[i], queens[j]):
                return False  # Если найдена бьющая пара, возвращаем False
    return True  # Если не найдено бьющих пар, возвращаем True
